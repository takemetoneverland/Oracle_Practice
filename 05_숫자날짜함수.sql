-- 숫자 함수
-- ROUND(반올림)
-- 소숫점 1번째 위치 반올림, 0번째 위치 반올림, 좌측 1번째 위치 반올림
SELECT ROUND(3.1415,2), ROUND(45.923,0), ROUND(45.923,-1)
FROM dual;

-- TRUNC(절사, 반내림)
-- 정해진 소수점 자리수까지 잘라낸다.
SELECT TRUNC(3.1496,2), TRUNC(45.923,0), TRUNC(45.923,-1)
FROM dual;
...
SELECT TRUNC(sysdate, 'day') FROM dual; -- 일 기준으로 절사(해당 주의 일요일 날짜 기준)
